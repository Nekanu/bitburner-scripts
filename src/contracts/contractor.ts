...
import { getFilePath, getNsDataThroughFile, disableLogs, scanAllServers } from 'contracts/helpers.js';
...
export async function main(ns) {
    ...
    ns.run(getFilePath('/contracts/run-with-delay.js'), 1, scriptSolver, 1, JSON.stringify(contractsDb));
}